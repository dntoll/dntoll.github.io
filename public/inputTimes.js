...
const inputTimes = [
    ...
    { title: "Valfri posering", count: 1, duration: 7 * 60, color:  runPoseColor, audio: audio_7m },

    { title: "Rast", count: 1, duration: 3 * 60, color:  "#fff0f0", audio: audio_pause },
    ...
    { title: "Valfri posering", count: 1, duration: 5 * 60, color:  runPoseColor, audio: audio_5m },

    { title: "Rast", count: 1, duration: 15 * 60, color:  "#fff0f0", audio: audio_pause },

    { title: "Posering", count: 10, duration: 30, color:  runPoseColor, audio: audio_30s },
    { title: "Posering", count: 5, duration: 3 * 60, color:  runPoseColor, audio: audio_3m },
    { title: "Valfri posering", count: 1, duration: 2 * 60, color:  runPoseColor, audio: audio_2m },
